...
var PageName = 'Add New User';
var PageId = 'df2264caf2e14038b78ca066e0040dbc'
var PageUrl = 'Add_New_User.html'
...
if (bIE) u110.attachEvent("onchange", Changeu110);
else u110.addEventListener("change", Changeu110, true);
function Changeu110(e)
{
windowEvent = e;


if ((GetSelectedOption('u110')) == ('新闻控制台')) {

	self.location.href="My_Published_Posts.html" + GetQuerystring();

}
else
if ((GetSelectedOption('u110')) == ('社区控制台')) {

	self.location.href="Community_Console.html" + GetQuerystring();

}
else
if ((GetSelectedOption('u110')) == ('通用控制台')) {
...
if (true) {
	...
	self.location.href="Column_Writer.html" + GetQuerystring();
