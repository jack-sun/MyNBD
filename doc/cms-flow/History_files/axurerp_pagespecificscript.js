...
var PageId = '2c831953780b4bb9b358b1ec0e325b00'
...
if (true) {
	...
	self.location.href="Edit_Ad.html" + GetQuerystring();
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u168ann'), "<div id='u168Note' class='annnoteimage' style='left:" + x + ";top:" + y + "'></div>");
$('#u168Note').click(function(e) { ToggleWorkflow(e, 'u168', 300, 150, false); return false; });
var u168Ann = 
{
"label":"?",
"Description":"点击后Confirm确认"};
